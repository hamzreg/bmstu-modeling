from commission.enrollee_generator import (
    EnrolleeGenerator, 
    choose_department_type)
from commission.handler import Handler
from commission.receiver import Receiver
from commission.event import Event, sort_events
    ...
    def service_enrollees(self, probabilities):
        ...
        while generated_enrollees < self.enrollee_generator.number:
            ...
            if isinstance(event.creator, EnrolleeGenerator):
                ...
                self.enrollee_generator.generate_enrollee(event.time)
                generated_enrollees += 1
